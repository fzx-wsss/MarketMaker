...
public abstract class OkAbstractSubscriber extends AbstractSubscriber {
    ...
    public void receive(String msg) {
        try {
            ...
            if(symbolQueryService.getMappingSymbolInfo(Source.Okex,childSymbolName).isEmpty()) {
                log.warn("childSymbolName:{} mapping symbol info is empty",childSymbolName);
            }
            symbolQueryService.getMappingSymbolInfo(Source.Okex,childSymbolName).forEach(symbolInfo -> {
