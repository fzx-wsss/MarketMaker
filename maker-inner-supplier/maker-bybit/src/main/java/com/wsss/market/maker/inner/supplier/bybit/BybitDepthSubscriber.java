...
public class BybitDepthSubscriber extends BybitAbstractSubscriber {
    ...
    public void receive(String msg) {
        ...
        if(symbolQueryService.getMappingSymbolInfo(Source.Bybit,childSymbolName).isEmpty()) {
            log.warn("childSymbolName:{} mapping symbol info is empty",childSymbolName);
        }
        symbolQueryService.getMappingSymbolInfo(Source.Bybit,childSymbolName).forEach(symbolInfo -> {
